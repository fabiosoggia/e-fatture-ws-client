...
class SdiNotificationEnum {
    ...
    public const NOTIFICA_ESITO = "NotificaEsito";
    public const NOTIFICA_DECORRENZA_TERMINI = "NotificaDecorrenzaTermini";
    public const ATTESTAZIONE_TRASMISSIONE_FATTURA = "AttestazioneTrasmissioneFattura";
}